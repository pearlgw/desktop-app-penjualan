...
namespace Penjualan
{
    public partial class Admin : Form
    {
        ...
        void refresh_barang()
        {
            ...
            {
                conn.Open();
                cmd = new SqlCommand("select * from Pengguna where Role = 'admin'", conn);
                ds = new DataSet();
        ...
        void auto_number()
        {
            ...
            if (rd.HasRows)
            {
                ...
                urut = "ADM" + joinstr.Substring(joinstr.Length - 3, 3);
            }
            else
            {
                urut = "A001";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlConnection conn = con.GetConn();
                cmd = new SqlCommand("insert into Pengguna values ('" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "','" + textBox6.Text + "', 'admin')", conn);
                conn.Open();
                cmd.ExecuteNonQuery();
